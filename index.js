...
function get20s(array) {
  ...
  for (let i = 0; i < artists.length; i++) {
    if (artists[i].years.includes("1904")|| artists[i].years.includes("1907")) {
...
function removeArtist(array, elem) {
  var index = artists.indexOf(elem);
  if (index > -1){
...
function addArtist(array,) {
  let arra = [...artists];
  arra.push(20,"Markel White","1993-2021","Web Design","American","We are all God's children. What a wonderful day?");
    return arra;
}
